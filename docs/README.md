...
These pages describe the current Home API architecture. Generated pre-rewrite
BMAD material is historical, not an alternative runbook or active backlog.

| Page | For |
| ---- | --- |
| [Setup](setup.md) | First install on a new box and a new library |
